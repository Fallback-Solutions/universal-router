...
import {V2ForkLibrary} from './V2ForkLibrary.sol';
...
abstract contract V2ForkSwapRouter is Permit2Payments {
    ...
    /// @dev `pair` is trusted to hold both tokens and to sort them by address
    function v2ForkSwapExactInput(
        ...
        // quote before paying, so these reserves do not yet include amountIn
